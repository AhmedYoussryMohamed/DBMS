...
public class Parser_Test {
	...
	public void test() {
		...
		object.setPathParser(  System.getenv("ahmed") +"test\\");
		
	//	Boolean test1= object.splitAll("CREATE DATABASE menagerie");
		Boolean test1= object.splitAll("USE database menagerie");
	//	Boolean test2 =object.splitAll("create table Persons (FirstName VARCHAR, LastName Varchar, Age varchar)");
		Boolean test3= object.splitAll("INSERT INTO Persons (FirstName, LastName, Age) VALUES ('omar', 'Griffin',35)");
		Boolean test4= object.splitAll("SELECT FirstName , LastName FROM Persons WHERE FirstName = omar");
		Boolean test5= object.splitAll("DELETE FROM Persons WHERE LastName = Griffin and Age = 35");
		Boolean test6= object.splitAll("UPDATE Persons SET  Age=36,FirstName = ahmed WHERE FirstName = 'omar'");
		...
		Boolean t5= object.splitAll("DELETE FROM Persons  LastName>'Griffin'");
		...
		Boolean a5= object.splitAll("DELETE FROM Persons WHERE LastName='Griff?klin");
